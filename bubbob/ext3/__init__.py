...
from bubbob.mnstrmap import GreenAndBlue, Fire
from bubbob.bonuses import Bonus
from bubbob.player import Dragon, BubPlayer
from bubbob import monsters
...
class Alien(monsters.Monster):
    ...
    def __init__(self, galaga, squadron, rank, relativey):
        ...
        if squadron % 3 == 2:
            from bubbob.mnstrmap import Ghosty as mcls
        else:
            from bubbob.mnstrmap import Flappy as mcls
