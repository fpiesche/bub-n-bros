...
from bubbob.mnstrmap import GreenAndBlue
from bubbob.bubbles import BubblingEyes, Bubble
from bubbob.bonuses import Bonus, points
...
class Tetris:
    ...
    def bgen(self, limittime = 90.1): # 1:30
        from bubbob import boards
        from bubbob.player import BubPlayer
